...
public class StoreService : IStoreService
{
	...
	public async Task<string?> GetPriceAsync()
	{
		...
		var listingsQueryResult = await context.GetStoreProductsAsync([ProductType.Durable.ToString("g")], [AwaitickProId]);
	...
	{
		var context = GetStoreContext();
		var purchaseResult = await context.RequestPurchaseAsync(AwaitickProId);
